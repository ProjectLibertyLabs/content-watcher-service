...
You can now find the `content-watcher-service` repository within the [AmplicaLabs/gateway](https://github.com/AmplicaLabs/gateway.git) repository at the following path:
